...
const ListingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://localhost:5000/api/market/submit', data, {
        headers: { 
      ...
      <form className="sell-form" onSubmit={handleSubmit}>
        ...
        <section className="form-section card">
          ...
          <div className="upload-area">
            <input 
              type="file" id="photo-upload" multiple 
              accept=".heic,.jpg,.jpeg,.png" onChange={handleImageChange} hidden 
            />
        ...
        <section className="form-section card">
          <div className="section-title-box">
            ...
            <div className="tooltip"><Info size={14} /> <span>Detailed specs help buyers decide faster.</span></div>
          </div>
          ...
          <div className="highlights-list">
            {highlights.map((h, index) => (
              <div key={index} className="highlight-item">
                <input 
                  type="text" placeholder="e.g. Subframe reinforced with Turner plates" 
                  value={h} onChange={(e) => updateHighlight(index, e.target.value)}
                />
                {highlights.length > 1 && (
