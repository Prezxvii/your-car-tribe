  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        // 1. Save Tribes to localStorage for Homepage filtering
  ...
  return (
    <div className="onboarding-container">
      <div className="onboarding-card">
        ...
        {step === 2 && (
          <div className="step-content">
            ...
            <div className="form-inputs">
              <input 
                type="text" placeholder="Full Name" className="onboard-input"
              ...
              <div className="input-with-icon">
                ...
                <input 
                  type="text" placeholder="Username" className="onboard-input icon-padding"
              ...
              <div className="input-with-icon">
                ...
                <input 
                  type="email" placeholder="Email" className="onboard-input icon-padding"
              ...
              <div className="input-with-icon">
                ...
                <input 
                  type="password" placeholder="Password" className="onboard-input icon-padding"
                  onChange={(e) => setFormData({...formData, password: e.target.value})}
                />
              </div>
            </div>
            <button className="btn-next-circle" onClick={nextStep}><ArrowRight size={24} /></button>
          </div>
        )}

        {/* STEP 3: FACTS (Required) */}
        {step === 3 && (
          <div className="step-content">
            ...
            <div className="input-field">
              ...
              <input 
                type="text" placeholder="e.g. 1992 Nissan 240SX" className="onboard-input"
            ...
            <div className="input-field">
              ...
              <input 
                type="text" placeholder="e.g. DIY Enthusiast" className="onboard-input"
        ...
        {/* STEP 4: TRIBES (Required - Impacts Feed) */}
        {step === 4 && (
          <div className="step-content">
        ...
        {step === 5 && (
          <div className="step-content text-center">
            <div className="success-wrapper"><CheckCircle size={100} color="#0066ff" /></div>
